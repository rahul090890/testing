...
<link href="js/controllers/jquery.dataTables.min.css" rel="stylesheet">
...
<body data-ng-class="{ 'sw-toggled': mactrl.layoutType === '1'}">
	...
	<script src="js/controllers/vfs_fonts.js"></script>
	<script src="js/controllers/ui-grid.js"></script>
